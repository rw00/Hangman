...
public abstract class ServerClientConnection {
     ...
     *
     * @param request the command protocol for requesting a new game
     ...
     *
     * @param game  the Hangman game being currently played
     * @param input the guess character of the Client
