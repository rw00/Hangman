...
public abstract class Server {
    ...
    protected final Map<String, Integer> hangmanGames; /* HangmanWord --> NumberOfTries */
    protected final List<String> hangmanWords; /* HangmanWords */
    ...
    public Server(String fileName) {
        ...
        hangmanGames = FileUtils.getAllHangmanGames(fileName);
        hangmanWords = new ArrayList<>(hangmanGames.keySet());
    ...
    /**
     * Handles any non-recoverable exceptions that might occur. Possibly during starting the Server. The Server will be
     * shut down then.
     *
